...
All revisions are
[automatically](https://github.com/p-b-o/qemu-linux-stack/blob/master/.github/workflows/build.yml)
built, [tagged](https://github.com/p-b-o/qemu-linux-stack/tags),
and added to [build release](https://github.com/p-b-o/qemu-linux-stack/releases/tag/build).
...
```
# A custom command can be passed to init script using INIT env var

INIT='hostname' ./run.sh qemu-system-hexagon

# In case command fail, init will trigger a Kernel panic
INIT='false' ./run.sh qemu-system-hexagon
```
...
./trace.sh /path/to/built/qemu-system-hexagon
...
