...
# To boot a vm and exit:
INIT='true' ./run.sh qemu-system-riscv64

# In case command fail, init will trigger a Kernel panic
INIT='false' ./run.sh qemu-system-riscv64
```
...
./trace.sh /path/to/built/qemu-system-riscv64
...
