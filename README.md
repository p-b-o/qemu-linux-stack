...
INIT='env INIT=hostname /host/host.sh qemu-system-ppc64' ./run.sh qemu-system-ppc64

# In case command fail, init will trigger a Kernel panic
INIT='false' ./run.sh qemu-system-ppc64
```
...
./trace.sh /path/to/built/qemu-system-ppc64
...
